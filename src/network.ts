// Network configuration, wallet seed/mnemonic handling, and deployment state
// persistence for PRIESTATE.
//
// All side-effecting inputs flow through function parameters; pure I/O lives
// in this module so it can be unit-tested without the Midnight SDK.
