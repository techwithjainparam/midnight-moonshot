 ...
 * Adapted from the Midnight leaderboard example (bboard example source) —
 * required by midnight-js contracts when running in a browser without the
 * LevelDB-based provider used by the CLI.
 */
